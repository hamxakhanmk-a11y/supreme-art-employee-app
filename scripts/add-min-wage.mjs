// Snapshots the minimum wage on each salary slip so historical EOBI
// calculations stay correct if the min wage constant changes later.
// Usage: node scripts/add-min-wage.mjs
...
const STMTS = [
  `ALTER TABLE salary_records ADD COLUMN IF NOT EXISTS minimum_wage INTEGER NOT NULL DEFAULT 37000`,
];
