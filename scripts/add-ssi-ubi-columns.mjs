// Add ssi_number and ubi_number columns to employees table
...
const stmts = [
  `ALTER TABLE employees ADD COLUMN IF NOT EXISTS ssi_number VARCHAR(40)`,
  `ALTER TABLE employees ADD COLUMN IF NOT EXISTS ubi_number VARCHAR(40)`,
];
