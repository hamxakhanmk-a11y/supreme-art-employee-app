// Add duties_assigned_to + medical_cert_attached columns to leave_requests
...
const stmts = [
  `ALTER TABLE leave_requests ADD COLUMN IF NOT EXISTS duties_assigned_to TEXT`,
  `ALTER TABLE leave_requests ADD COLUMN IF NOT EXISTS medical_cert_attached VARCHAR(4)`,
];
