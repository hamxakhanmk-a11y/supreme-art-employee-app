// Adds the resignation_date column to employees so we can record when an
// employee resigned (paired with status='resigned').
// Usage: node scripts/add-resignation-date.mjs
...
console.log("\n✅ employees.resignation_date added");
