...
(function (root) {
  ...
  api.output = function (kind) {
    ...
    win.document.write('<!doctype html><html><head><title>' + esc(title) + '</title><style>' + css +
      '@page{size:A4 landscape;margin:5mm}body{margin:0;color:#111}header{display:flex;align-items:center;background:#f5f5f5;border:1px solid #222;padding:2px 4px;gap:8px;break-inside:avoid;print-color-adjust:exact}.logo{width:150px;text-align:center;color:#a32d2d;font:bold 9px Arial}.logo img{display:block;width:80px;height:39px;object-fit:contain;margin:auto}.heading{flex:1;text-align:center}.heading h1{font:bold 14px Georgia;color:#a32d2d;margin:2px}.heading p,.note{font:8px Arial;margin:3px}section{margin-bottom:8px;break-after:auto}.movement-table{font-size:9px;line-height:1.15}.movement-table th,.movement-table td{padding:2px 3px;white-space:normal}.movement-table td.part-name{width:18%;min-width:0;max-width:180px;text-align:right;overflow-wrap:anywhere}.movement-table small{font-size:8px}</style></head><body>' + pages + '</body></html>');
    win.document.close();
