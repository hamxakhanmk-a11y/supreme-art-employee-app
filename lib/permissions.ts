...
export const MODULES: { key: ModuleKey; label: string; hint: string }[] = [
  ...
  { key: "purchase.edit",       label: "Purchase · Edit / Delete", hint: "Edit or delete an existing PR — value, remarks, received, HOD approval" },
...
const MASTER_EXPANSION: Record<string, ModuleKey[]> = {
  ...
  purchase: ["purchase.raise", "purchase.edit", "purchase.hr-approve"],
};
...
export const EDITABLE_ROLES = ["admin", "hr", "ceo", "procurement", "engineer", "finance", "other"] as const;
